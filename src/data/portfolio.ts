...
export const projects: Project[] = [
  ...
  {
  slug: "ai-events-admin-dashboard",
  title: "AI Events Admin Dashboard",
  value: "A production event management and CRM platform for managing B2B AI visibility events.",
  description:
    "Built a full-stack event management dashboard for BrandingBeez to manage registrations, sessions, attendance, analytics and post-event communication across multiple B2B AI visibility events.",
  technologies: [
    "React",
    "Node.js",
    "Express.js",
  ...
  categories: ["Production System", "Full Stack", "CRM"],
  liveUrl: "https://www.brandingbeez.co.uk/events-admin",
  liveLabel: "View Dashboard",
  featured: true,
  visual: "/projects/ai-events-admin.svg",
  flow: [
    "Registration",
    "Database",
    "Session Management",
  ...
  caseStudy: {
    challenge:
      "Managing registrations, event capacity, attendance and post-event communication across multiple B2B events required a centralized system with real-time operational visibility and flexible filtering.",
    architecture: [
      "React provides the admin dashboard interface and interactive management views.",
      "Node.js and Express.js expose REST APIs for registrations, sessions, attendance and communication workflows.",
      "MongoDB Atlas stores registrant, event, session and attendance data.",
      "Zepto Mail and Nodemailer handle transactional and bulk email communication.",
      "node-cron supports scheduled reminder and follow-up workflows.",
      "Google Tag Manager supports tracking and marketing attribution across event landing pages."
    ],
    workflow: [
      "Capture registrations from event landing pages.",
      "Store and organize registrant information in MongoDB.",
      "Associate each registrant with the appropriate event and session.",
      "Track confirmation status, attendance and remaining session capacity.",
      "Analyze registrations using event, session and landing-page filters.",
      "Send targeted reminders and post-event communication through the Email Center."
    ],
    responsibilities: [
      "Developed the admin dashboard interface and event management workflows.",
      "Implemented registration, session and attendance management functionality.",
      "Integrated REST APIs with MongoDB for live event data.",
      "Implemented multi-filter search and CSV export functionality.",
      "Integrated email services for reminders, follow-ups and post-event communication.",
      "Implemented email delivery-status tracking for sent and bounced messages.",
      "Worked on analytics views for registration trends and event performance."
    ],
    decisions: [
      "Centralized event, registration and attendance data into a single operational dashboard.",
      "Used multi-dimensional filtering to help administrators quickly locate specific registrants.",
      "Separated event capacity management from registration records for clearer operational control.",
      "Integrated delivery-status information so email follow-ups could be monitored from the dashboard.",
      "Added CSV export functionality for offline reporting and operational analysis."
    ],
    outcome:
      "The platform provides a centralized production workflow for managing B2B event registrations, session capacity, attendance, analytics and email communication across multiple AI visibility events."
  }
},
{
  slug: "careers-admin-crm-dashboard",
  title: "Careers Admin CRM Dashboard",
  value: "A recruitment CRM for managing applications, interviews and candidate progression.",
  description:
    "Built a full-stack recruitment management dashboard for BrandingBeez to centralize job applications, candidate information, interview scheduling, attendance and hiring pipeline analytics.",
  technologies: [
    "React",
    "Node.js",
    "FastAPI",
  ...
  categories: ["Production System", "Full Stack", "Recruitment CRM"],
  liveUrl: "https://www.brandingbeez.co.uk/careers-admin",
  liveLabel: "View Dashboard",
  featured: true,
  visual: "/projects/careers-admin-crm.svg",
  flow: [
    "Job Application",
    "Candidate Database",
    "Screening",
  ...
  caseStudy: {
    challenge:
      "Managing applications across multiple open positions requires HR teams to quickly search candidates, track experience levels, schedule interviews and move applicants through different hiring stages without relying on scattered records.",
    architecture: [
      "React provides the recruitment dashboard and interactive candidate management interface.",
      "Node.js handles application and recruitment management APIs.",
      "FastAPI provides backend API support for recruitment workflows.",
      "MongoDB stores candidate profiles, application details, interview information and status history.",
      "REST APIs connect the frontend with recruitment data and management operations."
    ],
    workflow: [
      "Receive and store job applications from the careers system.",
      "Organize candidates by applied position and experience level.",
      "Search and filter candidates using role, location, status and experience.",
      "Review candidate information through the detailed candidate panel.",
      "Schedule and update interview dates and attendance.",
      "Move candidates through New, Shortlisted, Reviewed and Rejected stages.",
      "Use analytics to understand application distribution across open roles."
    ],
    responsibilities: [
      "Developed the recruitment admin dashboard and candidate management interface.",
      "Implemented application listing, filtering and search functionality.",
      "Built candidate detail views containing education, experience, CTC and interview information.",
      "Implemented candidate status and attendance management workflows.",
      "Developed interview management functionality with status-based candidate organization.",
      "Implemented CSV export for recruitment reporting.",
      "Worked on recruitment analytics and application distribution views.",
      "Integrated frontend workflows with backend REST APIs and MongoDB."
    ],
    decisions: [
      "Used a centralized candidate profile to keep application and interview information together.",
      "Separated application status from interview attendance to provide clearer recruitment tracking.",
      "Used a Kanban-style interview workflow for quick visibility into candidate progression.",
      "Added multi-field search and filtering to reduce the time required to locate candidates.",
      "Included CSV export to support HR reporting and offline analysis."
    ],
    outcome:
      "The recruitment CRM provides a centralized workflow for managing applications, candidate profiles, interviews, attendance and hiring-stage progression across multiple open positions."
  }
},
  {
